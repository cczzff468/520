...
export const Apps = {
  wechat: () => icon([['#6BF178', 0], ['#0BC41C', 1]], `
    <path d="M30 12c-10.6 0-19 6.6-19 14.7 0 4.8 2.7 9 7 11.6l-1.7 5.2c-.3.9.7 1.6 1.5 1.1l6.6-3.9c1.8.4 3.7.7 5.6.7 10.6 0 19-6.6 19-14.7S40.6 12 30 12z" fill="#fff"/>
    <circle cx="22.4" cy="26.7" r="2.1" fill="#0BC41C"/>
    <circle cx="30" cy="26.7" r="2.1" fill="#0BC41C"/>
    <circle cx="37.6" cy="26.7" r="2.1" fill="#0BC41C"/>`),
